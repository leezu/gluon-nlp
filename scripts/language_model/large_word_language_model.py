...
if args.char_cnn_embedding:
    ...
    subword_pad0 = nlp.data.batchify.Pad(pad_val=subword_pad_val)
    subword_pad1 = nlp.data.batchify.Pad(axis=1, pad_val=subword_pad_val)
...
def _split_and_sample(x, y):
    ...
    if args.char_cnn_embedding:
        ...
        xs = [
            subword_pad1([
                subword_pad0([idx_to_subword[idx] for idx in x[i]])
